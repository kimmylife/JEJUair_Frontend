...
public class UserController {
    ...
    @RequestMapping("/findPhoneUserInfo")
    ...
    @RequestMapping("/findUserInfoList") //안되냐 왜
    ...
    @RequestMapping("/mypage_main_nonmember") //안됨
    public ModelAndView mypage_main_nonmember() {
        return new ModelAndView("/user/pages/mypage/mypage_main/mypage_main_nonmember");
    }
    ...
    @RequestMapping("/avail_search") //안됨
    public ModelAndView avail_search() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/avail_search");
    }
    ...
    public ModelAndView view_passenger_input() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/view_passenger_input");
    }

    @RequestMapping("/seat_select")
    public ModelAndView seat_select() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/seat_select/seat_select");
    }

    @RequestMapping("/baggage_select")
    public ModelAndView baggage_select() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/seat_select/baggage_select/baggage_select");
    }

    @RequestMapping("/ancillary_gate")
    public ModelAndView ancillary_gate() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/seat_select/baggage_select/ancillary_gate/ancillary_gate");
    }

    @RequestMapping("/view_confirm") //안됨
    public ModelAndView view_confirm() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/seat_select/baggage_select/ancillary_gate/view_confirm/view_confirm");
    }

    @RequestMapping("/view_payment") //안됨
    public ModelAndView view_payment() {
        return new ModelAndView("/user/pages/travel_pre_info/ticket_reservation/booking/availability/avail_search/bundle_select/view_passenger_input/seat_select/baggage_select/ancillary_gate/view_confirm/view_payment/view_payment");
    }
    ...
    //응수 테스트
        ...
        @RequestMapping("/additionalInfo/advanceBaggage") //additionalInfo/advanceBaggage/localhost:10000/user/additionalInfo/advanceBaggage
        ...
        //boarding_info 시작(응수)
        @RequestMapping("/boardingInfo/airportInfo") //localhost:10000/user/boardingInfo/airportInfo
        public ModelAndView user_airportInfo() { return new ModelAndView("/user/pages/boarding_info/airport_info/airport_info");}
        ...
        @RequestMapping("/myPage/fastCheckIn") //localhost:10000/user/myPage/fastCheckIn
        ...
        public ModelAndView user_eventList() { return new ModelAndView("/user/pages/event/event_now/event");}
        //event 끝(응수)
    ...
    @RequestMapping("/login/nonuser_login")
    public ModelAndView nonuser_login() {
        return new ModelAndView("/user/pages/login/nonuser_login/nonuser_login");
    }
